...
class tree:
    ...
    def add(self,parent,new_node):
        if new_node.value.values()[0] < parent.value.values()[0]:
            # 根据key-value的value进行插入，插入值比父节点值大，所以在父节点左边
...
if __name__ == '__main__':
    ...
    #     print i,j
    print maplist[0].keys()[0]
    print maplist[0].values()[0]

    # t = tree()
    # t.create_tree(0,maplist)
    # # res = t.front()
    # # print('前序', res)
    # print('中序', t.middle())